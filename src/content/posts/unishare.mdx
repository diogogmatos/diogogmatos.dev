---
title: "UniShare"
summary: "Case study of an academic resource sharing platform developed as part of a Web Engineering course, with features like resource submission, upvoting/downvoting, commenting, and user profiles."
date: "2024-07-02"
cover: "/assets/unishare/unishare.webp"
coverAlt: "UniShare's Logo"
---

[**GitHub**](https://github.com/diogogmatos/EngWeb2024-Projeto)
...
![Dashboard](/assets/unishare/full_page.webp)
...
![Navbar](/assets/unishare/navbar.webp)
...
| ---------------------------------------- | --------------------------------------------------- | -------------------------------------------------- |
| ![Filters](/assets/unishare/filters.webp) | ![FiltersCurso](/assets/unishare/filter_search.webp) | ![FiltersUC](/assets/unishare/subjects_filter.webp) |
...
![AddResource](/assets/unishare/resource_dialog.webp)
...
![ResourceCard](/assets/unishare/card.webp)
...
| Standard User                            | Admin                                               |
| ---------------------------------------- | --------------------------------------------------- |
| ![Actions](/assets/unishare/actions.webp) | ![AdminActions](/assets/unishare/actions_admin.webp) |
...
![ResourcePage](/assets/unishare/resourcepage.webp)
...
![Edit](/assets/unishare/edit_resource.webp)
...
![Profile](/assets/unishare/profile.webp)
...
![ProfileComments](/assets/unishare/profile_comments.webp)

If the user is viewing their own profile, they also have the option to edit the profile or access account settings.

| Edit Profile                                      | Account Settings                                          |
| ------------------------------------------------- | --------------------------------------------------------- |
| ![EditProfile](/assets/unishare/edit_profile.webp) | ![AccountSettings](/assets/unishare/account_settings.webp) |
...
![Pagination](/assets/unishare/pagination.webp)
...
| Sign in                                | Sign up                                |
| -------------------------------------- | -------------------------------------- |
| ![Signin](/assets/unishare/signin.webp) | ![Signup](/assets/unishare/signup.webp) |
...
| -------------------------------------------- | ------------------------------------------ |
| ![LightMode](/assets/unishare/full_page.webp) | ![DarkMode](/assets/unishare/darkmode.webp) |
...
![NoPermission](/assets/unishare/nopermission.webp)
